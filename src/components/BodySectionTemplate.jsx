...
const BodySectionTemplate = ({children, subTitle, title, id, nextSection}) => {
  return (
    <section id={id} className='relative flex flex-col items-center w-full h-[96vh] min-h-fit box-border pt-[4vh] px-[10rem]'>
        ...
        <div className='absolute right-[5rem] bottom-[2.5rem] hover:cursor-pointer'>
            <a href={'#' + nextSection}><MdOutlineKeyboardDoubleArrowDown size='3rem'/></a>
        </div>
    </section>
  )
}
